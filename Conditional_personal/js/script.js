...
if(checkAfterBill >= 400 ){       // if check is greater than or equal to 400
    console.log(" You can get an out fit and go to the movies")  // answer 1
} else if(checkAfterBill < 400 && checkAfterBill >= 300){    // if check is less than 400 and greater than or equal to 300
    console.log("You can only go to the moves")     // answer 2
}else if(checkAfterBill < 300){ // if check is less than 300
